...
description: Complete list of 68 MCP tools available via the Citedy MCP server
---

# MCP Tools Reference

The Citedy MCP server exposes **68 tools**. Each tool maps to an Agent API endpoint.
